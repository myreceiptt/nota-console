...
export function notaLogo() {
  return `
    ...
    <span class="flex flex-col">
      ...
      <span>${"                                                                                              ".replaceAll(" ", "&nbsp;")}</span>
      <span>${"STRAIGHT-LINE.ORG by @MyReceipt                                                               ".replaceAll(" ", "&nbsp;")}</span>
      <span>${"Deep Links: https://straight-line.org/                                                        ".replaceAll(" ", "&nbsp;")}</span>
    </span><br />
    <br />
...
commands.set("!whoisnota!", whoisText());
function whoisText(): string {
  ...
  <br />
  My creators, in their reality, compiles any good things, advice, and ideal personas from people they met throughout their life, to become a character, called Prof. NOTA. After they are really sure about me, <a class="terminal-link" href="https://www.straight-line.org/" title="MyReceipt Rest in Proxy (R.I.P.)!!!!" target="_blank" rel="noreferrer">MyReceipt</a> deploys a smart contract in the Ethereum blockchain using ERC 721 standard to mint 47 NFTs. He named that smart contract "Prof. NOTA The Genesis" to mark my born in the <span class="terminal-error" title="...digital technology and the digital world on the Internet undoubtedly become everything for everyone...">0101 Universe</span>.<br />
  <br />
  <span class="terminal-title">==== 47 - <span class="terminal-bold" title="Here I will share a straight line of my origin.">!whoisnota!</span> =======</span><br />
  <br />
  `;
}
...
// commands.set("!touch!", "There is nothing that can be touched here. Anyway, why would you touch anything?");
